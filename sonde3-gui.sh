...
#Stick 1
xfce4-terminal --minimize --title SCANNER1 -e 'bash -c "scanner -p 18051 -u 17051 -f 404000000 -s 1500 -v -o $DXLPATH/sdrcfg1.txt -b $DXLPATH/blacklist.txt -w $DXLPATH/whitelist.txt -q 55 -n 5"' &
#Stick 2
xfce4-terminal --minimize --title SCANNER2 -e 'bash -c "scanner -p 18052 -u 17052 -f 400000000 -s 1500 -v -o $DXLPATH/sdrcfg2.txt -b $DXLPATH/blacklist.txt -w $DXLPATH/whitelist.txt -q 55 -n 5"' &
