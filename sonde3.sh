...
sleep 1
# Stick 1
rtl_tcp -a 127.0.0.1 -d1 -p 18201 -P 0 -g 0 -n 1 &
sleep 1
# Stick 2
rtl_tcp -a 127.0.0.1 -d2 -p 18202 -P 0 -g 0 -n 1 &
sleep 1
...
sleep 1
# Stick 1
sdrtst -t 127.0.0.1:18201 -r 26000 -s $DXLPATH/sondepipe1 -Z 100 -c $DXLPATH/sdrcfg1.txt -L 127.0.0.1:18051 -a 15 -e -k -v &
sleep 1
# Stick 2
sdrtst -t 127.0.0.1:18202 -r 26000 -s $DXLPATH/sondepipe2 -Z 100 -c $DXLPATH/sdrcfg2.txt -L 127.0.0.1:18052 -a 15 -e -k -v &
sleep 1
...
sleep 1
# Stick 1
sondeudp -f 26000 -o $DXLPATH/sondepipe1 -I $SONDECALL -L SDR1 -u 127.0.0.1:18000 -M 127.0.0.1:17051 -c 0 -v -n 0 -W 5 &
sleep 1
# Stick 2
sondeudp -f 26000 -o $DXLPATH/sondepipe2 -I $SONDECALL -L SDR2 -u 127.0.0.1:18000 -M 127.0.0.1:17052 -c 0 -v -n 0 -W 5 &
sleep 1

# Umwandeln der Sondendaten in AXUDP Format (SONDEMOD)
sondemod -o 18000 -I $SONDECALL -r 127.0.0.1:9001 -b $INTERVALLHIGH:$INTERVALL1:$INTERVALL2:$INTERVALL3 -A $ALT1:$ALT2:$ALT3 -x /tmp/e.txt -J 127.0.0.1:18001 -T 360 -R 240 -d -p 2 -M -L 6=DFM06,7=PS15,A=DFM09,B=DFM17,C=DFM09P,D=DFM17,FF=DFMx -t $DXLPATH/sondecom.txt -v -P $LOCATOR -N $HOEHE -S $DXLPATH/ &
sleep 1
...
#python $DXLPATH/dxlAPRS-SHUE/dxlAPRS-SHUE.py -a 127.0.0.1 -p 18001 -k 0 -c $SONDECALL -l $LAT,$LON,$HOEHE -u $EMAIL &
sleep 1
